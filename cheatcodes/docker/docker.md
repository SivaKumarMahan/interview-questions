...
Prefer pulling and running by immutable digest (`<image>@sha256:<digest>`) in production. Inspect and back up state before pruning; do not use "remove everything" commands on production hosts.
